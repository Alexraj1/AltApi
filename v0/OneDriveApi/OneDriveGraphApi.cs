...
using AltApi.Api.Helpers;
using System.Collections.Generic;
using System.Net.Http;
using AltApi.Api.Enums;
using System.IO;
using OneDriveApi.Entities;

namespace AltApi.Api
{
    /// <summary>
    ...
    public class OneDriveGraphApi : OneDriveApi
    {
        ...
        public OneDriveUserAccount oneDriveUserProfile { get; set; }
        ...
        /// <param name="applicationId">Microsoft Application ID to use to connect</param>
        /// <param name="clientSecret">Microsoft Application secret to use to connect</param>
        public OneDriveGraphApi(string applicationId, string redirecturl, string clientSecret = null) : base(applicationId, clientSecret)
        {
        ...
        /// </summary>
        /// <returns>OneDriveItem object with the information about the current App Registration its AppFolder</returns>
        public async Task<OneDriveUserAccount> GetProfil()
        {
            var completeUrl = string.Concat(OneDriveApiBaseUrl, "");

            var result = await SendMessageReturnOneDriveItem<OneDriveUserAccount>(string.Empty, HttpMethod.Get, completeUrl, HttpStatusCode.OK);
